...
public class InicioTemplate extends JPanel{
    ...
    public void crearObjetosDecoradores(){
        this.iTarjeta1 = new ImageIcon("Clase9/resources/img/tarjeta1.jpg");
        this.iTarjeta2 = new ImageIcon("Clase9/resources/img/tarjeta2.jpg");
        this.iTarjeta3 = new ImageIcon("Clase9/resources/img/tarjeta3.jpg");
        this.iClase = new ImageIcon("Clase9/resources/img/clases.png");
        this.iPantalla = new ImageIcon("Clase9/resources/img/pantalla.png");
        this.iCelular = new ImageIcon("Clase9/resources/img/celular.png");
        this.iIdea = new ImageIcon("Clase9/resources/img/ideas.png");
        this.iEstadistica = new ImageIcon("Clase9/resources/img/estadisticas.png");
        this.iDireccion = new ImageIcon("Clase9/resources/img/direccion.png");
    }
