...
public class RecursosService {
  ...
  private void crearImagenes() {
    iCerrar = new ImageIcon("Clase9/resources/images/cerrar.png");
    iMinimizar = new ImageIcon("Clase9/resources/images/minimizar.png");
  }
  ...
  private void generarFuentes() {
    try {
      ...
      ge.registerFont( Font.createFont(
          Font.TRUETYPE_FONT,
          new File("Clase9/resources/fonts/LUZRO.ttf")
      ));
